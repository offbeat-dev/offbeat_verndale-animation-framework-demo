...
const results = [
  {
    ...
    image: 'https://verndale-image-tools.azurewebsites.net/id/FVxkTX-Ejec?w=300&h=500'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    image: 'https://verndale-image-tools.azurewebsites.net/id/HGVtA1zSHo4?w=300&h=500'
  },
  {
    id: 4,
  ...
  },
  {
    ...
    image: 'https://verndale-image-tools.azurewebsites.net/id/hoV4nneXR-U?w=300&h=500'
  },
  {
    id: 6,
...
export const Default: Story = {
  args: {
    endpoint: endpoint,
    heading: 'Mocked API',
    description: 'API for featured articles listing'
  },
  parameters: {
    msw: {
      handlers: [
